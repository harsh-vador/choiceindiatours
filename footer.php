...
echo "
		<footer id='colorlib-footer' role='contentinfo'>
			<div class='container'>
				...
				<center>
					<a href='contact.php' class='btn btn-primary btn-outline'>Ask Questions ?</a>
				</center>
				<br><br>
				<div class='row'>
					<div class='col-md-12 text-center'>
						<p>
							...
							<span class='block'>Demo Images: <a href='http://unsplash.com/' target='_blank'>Unsplash</a> , <a href='http://pexels.com/' target='_blank'>Pexels.com</a></span>
						</p>
					</div>
				</div>
			</div>
