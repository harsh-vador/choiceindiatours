	...
	$query=mysqli_query($conn,"select count(tour_id) from `tours` where type='international'");
	...
	$nquery=mysqli_query($conn,"select * from `tours` where type='international' order by tour_id desc $limit;" );
	$paginationCtrls = '';
		...
		<div id="page">
			...
			<aside id="colorlib-hero">
				<div class="flexslider">
					<ul class="slides">
						<li style="background-image: url(images/bangkok.jpg);">
							...
							<div class="row">
								<div class="wrap-division">
									...
									while($crow = mysqli_fetch_array($nquery)){
										...
										<a href="#" class="hotel-img" style="background-image: url('.$crow['image_url'].');">
